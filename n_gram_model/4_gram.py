...
four_gram_model = NGramLanguageModel(n=4)
...
four_gram_model.train(train_corpus)
# returns a log probability
score = four_gram_model.score(test_corpus)
print(score)

generated_text = four_gram_model.predict(test_corpus, max_length=100)
print(generated_text)

perplexity = four_gram_model.perplexity(["Git is a common choice for version control in software development."])
print(perplexity)